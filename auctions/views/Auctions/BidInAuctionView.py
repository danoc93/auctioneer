...
from auctioneer_api.api.parameters import get_string_parameter, get_number_parameter
from common.models.Auction import Auction
from common.models.AuctionStatus import AuctionStatusOption
...
class BidInAuctionView(APIView):
    ...
    def post(self, request, auction_id):
        ...
        auction_id = get_number_parameter({'id': auction_id}, 'id', int, True)
